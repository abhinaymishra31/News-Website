<%@ Page Title="" Language="C#" MasterPageFile="admin.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" enableEventValidation="false"%>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="slider_area">
      <div class="slider" >
        <ul class="bxslider">
          <li><img src="images/news1.jpg" style="height:400px;width:1320px;"" alt="" title="Slider caption text" /></li>
          <li><img src="images/ipl.jpg" alt="" title="Slider caption text" /></li>
          <li><img src="images/sonu.jpg" alt="" title="Slider caption text" /></li>
        </ul>
      </div>
    </div>
    <div style="align-content:center;margin-right:70px;">
      <asp:HiddenField ID="hdnfldVariable" runat="server" />
        <asp:TextBox ID="TextBox3" runat="server" TextMode="Date"></asp:TextBox>
        <asp:ImageButton ID="ImageButton4" runat="server" Height="38px" ImageUrl="~/search.png" OnClick="ImageButton4_Click" />
