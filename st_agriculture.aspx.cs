...
public partial class st_agriculture : System.Web.UI.Page
{
   SqlConnection con;
    SqlCommand cmd,cmd1;
    SqlDataReader dr;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            con.Open();
            string query = "select top 6 * from tbl_news category=Sci-Tech AND subcategory=Agriculture order by date desc";
