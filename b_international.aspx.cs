...
public partial class b_international : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            con.Open();
            string query = "select top 6 * from tbl_news category=Bussiness AND subcategory=International order by date desc";
