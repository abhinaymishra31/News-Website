...
public partial class b_indbusiness : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd, cmd1;
    SqlDataReader dr;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            con.Open();
            string query = "select top 6 * from tbl_news category=Bussiness AND subcategory=India Bussiness order by date desc";
